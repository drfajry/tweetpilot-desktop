      ...
      try {
        ...
        if (prep && prep.ok && prep.box && alive()) {
          ...
          try {
            ...
            if (nimg && !nimg.isEmpty()) { const b = nimg.toJPEG(92); if (b && b.length > 2000) buf = b; }
          } catch(e) { entry.capErr = String(e).slice(0, 60); }
          if (!buf && attached && alive()) {
            ...
            if (shot && shot.data && shot.data.length > 2000) buf = Buffer.from(shot.data, 'base64');
          }
          if (buf) {
